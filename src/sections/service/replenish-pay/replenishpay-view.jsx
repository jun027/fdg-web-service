...
import payFormService from '@/services/replenish/payform'
import useReplenishFormContext from '@/store/use-replenish-form-context'
import { zodResolver } from '@hookform/resolvers/zod'
import { useRouter } from '@/routes/hooks'

function ReplenishpayView() {
  const router = useRouter()

  const getData = useReplenishFormContext((state) => state.getData)
        ...
        <div className="bg-white py-6 px-4 rounded-2xl w-full mx-auto lg:w-[1120px]">
          ...
          <div className="flex items-center justify-center gap-x-2 sm:gap-x-3 pb-6 max-w-full mx-auto whitespace-nowrap">
            <div className="flex flex-col items-center">
              ...
              <span className="mt-2 text-primary-500 mobile-medium-h4 lg:desktop-regular-h6">
                填寫資料
              </span>
            </div>
...
export default ReplenishpayView
