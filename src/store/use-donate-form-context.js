  ...
  storeFormData: (payload) => {
    set(
      produce((draft) => {
        ...
        draft.service_list.item_id = payload.service_list.item_id
        draft.service_list.id_number = payload.service_list.id_number
        draft.service_list.no_public = payload.service_list.no_public
  ...
  getData: () => {
    ...
    return {
      service_list: {
        ...
        item_id: get().service_list.item_id,
        id_number: get().service_list.id_number,
        no_public: get().service_list.no_public,
      },
      payform: {
        name: payform.name,
        phone: payform.phone,
  ...
  clearData: () => {
    set(
      produce((draft) => {
        ...
        draft.service_list.item_id = 0
        draft.service_list.id_number = ''
        draft.service_list.no_public = false
        draft.payform.name = ''
        draft.payform.phone = ''
        draft.payform.email = ''
        draft.payform.city = ''
